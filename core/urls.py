...
urlpatterns = [
    ...
    path('admin/institute-risk-criteria/', views.admin_institute_risk_criteria, name='admin_institute_risk_criteria'),
    path('admin/department-risk-criteria/', views.admin_department_risk_criteria, name='admin_department_risk_criteria'),
